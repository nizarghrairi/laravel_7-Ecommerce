...
$(document).ready(function(){
    ...
    ********************************/
    ...
    // Get Image Data
    $('.get-images-data-btn').on('click',function(){
        result = $image.cropper("getImageData");
        $('.get-images-data').val(JSON.stringify(result));
    });
    ...
    ***********************************/
    $('.rotate-images').cropper({
        ...
        zoomOnWheel: false,
        built: function () {
            $('.rotate-images').cropper('rotate', 45);
        }
    });
    ...
    **********************************/
    $('.scale-images').cropper({
        ...
        zoomOnWheel: false,
        built: function () {
            $('.scale-images').cropper('scale', -1); // Flip both horizontal and vertical
        }
    });
