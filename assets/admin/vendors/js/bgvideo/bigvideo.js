...
(function (factory) {
	...
	$.BigVideo = function(options) {
		...
		function playVideo(source) {
			...
			$('#big-video-images').css('display','none');
			$(vidEl).css('display','block');
		}

		function showPoster(source) {
			// remove old images
			$('#big-video-images').remove();
			...
			// show images
			currMediaType = 'image';
			var bgImage = $('<img id="big-video-images" src='+source+' />');
			wrap.append(bgImage);

			$('#big-video-images').imagesLoaded(function() {
				mediaAspect = $('#big-video-images').width() / $('#big-video-images').height();
				updateSize();
			});
		}
		...
		BigVideo.show = function(source,options) {
			...
			if (typeof(source) === 'string') {
				// if input was a string, try show that images or video
