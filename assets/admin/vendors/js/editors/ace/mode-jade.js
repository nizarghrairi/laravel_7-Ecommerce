...
var ScssHighlightRules = function() {
    ...
    var properties = lang.arrayToMap( (function () {
        ...
        var prefixProperties = ("appearance|background-clip|background-inline-policy|background-origin|" + 
             ...
             "border-end-style|border-end-width|border-images|border-start|" + 
             "border-start-color|border-start-style|border-start-width|box-align|" + 
             "box-direction|box-flex|box-flexgroup|box-ordinal-group|box-orient|" + 
             "box-pack|box-sizing|column-count|column-gap|column-width|column-rule|" + 
             "column-rule-width|column-rule-style|column-rule-color|float-edge|" + 
             "font-feature-settings|font-language-override|force-broken-images-icon|" + 
             "images-region|margin-end|margin-start|opacity|outline|outline-color|" + 
        ...
        var properties = ("azimuth|background-attachment|background-color|background-images|" +
            ...
            "letter-spacing|line-height|list-style-images|list-style-position|" +
