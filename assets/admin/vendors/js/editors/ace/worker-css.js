...
var Properties = {
    ...
    "background-image"              : { multi: "<bg-images>", comma: true },
    ...
    "border-image-source"           : "<images> | none",
...
var ValidationTypes = {
    ...
    simple: {
        ...
        "<bg-image>": function(part){
            return this["<images>"](part) || this["<gradient>"](part) ||  part == "none";
        },
...
CSSLint.addRule({
    ...
    desc: "Every background-images should be unique. Use a common class for e.g. sprites.",
    browsers: "All",
    init: function(parser, reporter){
        var rule = this,
            stack = {};
                ...
                for (i=0, len=value.parts.length; i < len; i++) {
                    if (value.parts[i].type === "uri") {
                        if (typeof stack[value.parts[i].uri] === "undefined") {
                            ...
                            reporter.report("Background images '" + value.parts[i].uri + "' was used multiple times, first declared at line " + stack[value.parts[i].uri].line + ", col " + stack[value.parts[i].uri].col + ".", event.line, event.col, rule);
                        }
                    }
                }
            }
    ...
    init: function(parser, reporter){
        ...
        function endRule(){
            if (textIndent && direction !== "ltr"){
                reporter.report("Negative text-indent doesn't work well with RTL. If you use text-indent for images replacement explicitly set direction for that item to ltr.", textIndent.line, textIndent.col, rule);
            }
        }
