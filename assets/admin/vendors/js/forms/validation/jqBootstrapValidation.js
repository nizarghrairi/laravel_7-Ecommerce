(function ($) {
        ...
        methods: {
            init: function (options) {
                ...
                $(uniqueForms).bind("submit.validationSubmit", function (e) {
                    ...
                    var warningsFound = 0;
                    // Get all inputs
                    var $allInputs = $form.find("input,textarea,select").not("[type=submit],[type=images]").filter(settings.options.filter);
                        ...
                        function (e, params) {
                            ...
                            if (errorsFound.length) {
                                ...
                                if (settings.options.semanticallyStrict && errorsFound.length === 1) {
                                    ...
                                    $helpBlock.html("<ul role=\"alerts\"><li>" + errorsFound.join("</li><li>") + "</li></ul>" +
                                        ( settings.options.prependExistingHelpBlock ? $helpBlock.data("original-contents") : "" ));
                                }
                            } else {
    ...
    $.jqBootstrapValidation = function (options) {
        $(":input").not("[type=images],[type=submit]").jqBootstrapValidation.apply(this, arguments);
    };
